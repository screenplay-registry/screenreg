 ...
 *
 * The profile literal is inlined here rather than imported: the canonical
 * `src/anchors/eth/` module is Node-side (it carries a keccak dependency) and
 * MUST NOT be reachable from any `src/shared/**` module.
 */
